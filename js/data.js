...
const DEFAULT_COURSES = [
  // ── Khóa 1: Tạo hình ảnh bằng AI ──
  {
    ...
    thumbnail: 'https://i.ytimg.com/vi/B1hOFU-Wzf8/hqdefault.jpg',
    duration: '6 giờ',
    totalLessons: 4,
    level: 'Cơ bản',
  ...
  // ── Khóa 2: Tạo video bằng AI ──
  {
    ...
    thumbnail: 'https://i.ytimg.com/vi/d7oxhBrx4v8/hqdefault.jpg',
    duration: '7 giờ',
    totalLessons: 4,
    level: 'Trung cấp',
    allowedRoles: ['admin', 'employee_new', 'employee_old', 'customer'],
  ...
  // ── Khóa 3: AI Agent & Tự động hóa ──
  {
    ...
    thumbnail: 'https://i.ytimg.com/vi/lSwMtsm6oDU/hqdefault.jpg',
    duration: '8 giờ',
    totalLessons: 4,
    level: 'Nâng cao',
    allowedRoles: ['admin', 'employee_new', 'employee_old', 'customer'],
  ...
  // ── Khóa 4: Kỹ năng bán hàng ──
  {
    ...
    thumbnail: 'https://i.ytimg.com/vi/dxKTMvU_RXw/hqdefault.jpg',
    duration: '6 giờ',
    totalLessons: 4,
    level: 'Cơ bản',
    allowedRoles: ['admin', 'employee_new', 'employee_old', 'customer'],
  ...
  // ── Khóa 5: Kỹ năng giao tiếp ──
  {
    ...
    thumbnail: 'https://i.ytimg.com/vi/whpBTWvCU6o/hqdefault.jpg',
    duration: '5 giờ',
    totalLessons: 4,
    level: 'Cơ bản',
    allowedRoles: ['admin', 'employee_new', 'employee_old', 'customer'],
  ...
  // ── Khóa 7: Kỹ năng Lãnh đạo (Leadership) ──
  {
    ...
    thumbnail: 'https://i.ytimg.com/vi/L3R-RzQ_ZKA/hqdefault.jpg',
    duration: '8 giờ',
    totalLessons: 4,
    level: 'Nâng cao',
    allowedRoles: ['admin', 'employee_new', 'employee_old', 'customer'],
  ...
  // ── Khóa 8: Train the Trainer ──
  {
    ...
    thumbnail: 'https://i.ytimg.com/vi/0_YJWgSKPzw/hqdefault.jpg',
    duration: '7 giờ',
    totalLessons: 4,
    level: 'Trung cấp',
    allowedRoles: ['admin', 'employee_new', 'employee_old', 'customer'],
...
const DEFAULT_LESSONS = [
  // ── Khóa 1: Tạo ảnh bằng AI ──
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/B1hOFU-Wzf8',
    duration: '40 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/8p_hS2Z1M2M',
    duration: '50 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/Xh7P7D8m-r8',
    duration: '45 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/sO-o8F9hWq8',
    duration: '45 phút',
  ...
  // ── Khóa 2: Tạo video bằng AI ──
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/A-a1VrtPeTY',
    duration: '45 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/d7oxhBrx4v8',
    duration: '55 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/dpoMEcXjVH8',
    duration: '50 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/GuaKeDS6UKU',
    duration: '60 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/lSwMtsm6oDU',
    duration: '60 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/9lqloLQ1roc',
    duration: '65 phút',
  ...
  // ── Khóa 4: Kỹ năng bán hàng ──
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/pzPDE7S6sEc',
    duration: '45 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/dxKTMvU_RXw',
    duration: '50 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/gPcefP5Vrxk',
    duration: '50 phút',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/jfVi3jD6ym4',
    duration: '45 phút',
  ...
  // ── Khóa 5: Kỹ năng giao tiếp ──
  {
    ...
    title: 'Bài 1: Sức mạnh của Lắng nghe Chủ động & Làm chủ Giọng nói',
    description: 'Kỹ thuật kiểm soát hơi thở trước khi nói để giọng chắc và ấm hơn; kỹ thuật lắng nghe chủ động ở cấp độ 3 và phản hồi gương (mirroring) để thiết lập kết nối sâu sắc.',
    videoUrl: 'https://www.youtube.com/embed/k_WF7eqDLmQ',
    duration: '40 phút',
  ...
  },
  {
    ...
    title: 'Bài 2: Bí quyết "Ăn Nói" khéo léo & Tạo thiện cảm của người giao tiếp giỏi',
    description: 'Kiểm soát ánh mắt, nụ cười, dáng đứng và nghệ thuật dùng từ tinh tế để tạo thiện cảm và thuyết phục ngay từ 30 giây đầu tiên.',
    videoUrl: 'https://www.youtube.com/embed/M44jmuvYlbs',
    duration: '45 phút',
  ...
  },
  {
    ...
    title: 'Bài 3: Bí quyết để KHÔNG RUN khi Giao tiếp & Thuyết trình trước đám đông',
    description: 'Chiến lược tâm lý học kiểm soát nhịp tim, vượt qua nỗi sợ sân khấu và làm chủ năng lượng trước khán phòng hàng trăm người.',
    videoUrl: 'https://www.youtube.com/embed/whpBTWvCU6o',
    duration: '45 phút',
  ...
  },
  {
    ...
    title: 'Bài 4: Cách giao tiếp thông minh, khéo léo để được tôn trọng và yêu quý',
    description: 'Tư duy Win-Win trong đàm phán, nghệ thuật truyền đạt thông điệp khúc chiết và xây dựng mối quan hệ đối tác bền vững.',
    videoUrl: 'https://www.youtube.com/embed/4lPWAWZMIBk',
    duration: '50 phút',
  ...
  // ── Khóa 7: Kỹ năng Lãnh đạo (Leadership) ──
  {
    ...
    title: 'Bài 1: Kỹ năng Lãnh đạo Thực chiến & Thấu hiểu Năng lực Bản thân',
    ...
    videoUrl: 'https://www.youtube.com/embed/L3R-RzQ_ZKA',
    duration: '55 phút',
  ...
  },
  {
    ...
    title: 'Bài 2: Xây dựng Đội ngũ Vững mạnh & Văn hóa Gắn kết Mục tiêu',
    ...
    videoUrl: 'https://www.youtube.com/embed/w-E0we4apy0',
    duration: '60 phút',
  ...
  },
  {
    ...
    title: 'Bài 3: Nghệ thuật Ủy quyền, Giao việc & Quản trị Hiệu suất',
    ...
    videoUrl: 'https://www.youtube.com/embed/PTDkMQ8xKJM',
    duration: '50 phút',
  ...
  },
  {
    ...
    title: 'Bài 4: Kỹ năng Phản hồi Xây dựng & Giải quyết Xung đột Nội bộ',
    ...
    videoUrl: 'https://www.youtube.com/embed/8TPfgc0W0w8',
    duration: '65 phút',
  ...
  // ── Khóa 8: Train the Trainer ──
  {
    ...
    title: 'Bài 1: Đào tạo là Kỹ năng Dễ dàng Học và Làm được – Train The Trainer',
    ...
    videoUrl: 'https://www.youtube.com/embed/0_YJWgSKPzw',
    duration: '50 phút',
  ...
  },
  {
    ...
    title: 'Bài 2: Toàn cảnh Đào tạo Giảng viên Nội bộ & Thiết kế Giáo án Tương tác',
    ...
    videoUrl: 'https://www.youtube.com/embed/f-UZgjdra6A',
    duration: '60 phút',
  ...
  },
  {
    ...
    title: 'Bài 3: Kỹ năng Điều phối Lớp học (Facilitation) & Huấn luyện Quản lý Đội ngũ',
    ...
    videoUrl: 'https://www.youtube.com/embed/i59LcVpb3sA',
    duration: '55 phút',
  ...
  },
  {
    ...
    title: 'Bài 4: Thao giảng Thực chiến & Đánh giá Hiệu quả Sau Đào tạo',
    ...
    videoUrl: 'https://www.youtube.com/embed/Rv8D9uVzViI',
    duration: '50 phút',
...
// ─── Official YouTube & Demo Showcase Videos ───────────────────
const OFFICIAL_YOUTUBE_VIDEOS = [
  // ── 1. Kênh Chính Thức Ohana Astronixa VN ──
  {
    id: 'G2KI_UpLvj4',
    ...
    group: 'ohana',
    channel: 'Ohana Astronixa VN',
    badge: 'Ohana Official',
    embedUrl: 'https://www.youtube.com/embed/G2KI_UpLvj4',
    watchUrl: 'https://www.youtube.com/watch?v=G2KI_UpLvj4',
    thumbnail: 'https://i.ytimg.com/vi/G2KI_UpLvj4/hqdefault.jpg',
    courseId: 6,
    lessonId: 21,
    description: 'Video văn hóa chính thức lan tỏa thông điệp: Chung Vũ Trụ! Chung Mái Nhà! Gắn kết đại gia đình Ohana Astronixa, không ai bị bỏ lại phía sau.'
  },
  {
    id: 'mNPxj-qGiUU',
    title: 'OHANA THEME SONG (VN VERSION): Ohana! Một vũ trụ! Một gia đình!',
    duration: '7:32',
    category: 'Ca khúc truyền thống',
    group: 'ohana',
    channel: 'Ohana Astronixa VN',
    badge: 'Bài Hát Ohana',
    ...
    courseId: 6,
    lessonId: 22,
    description: 'Ca khúc truyền thống hào hùng phiên bản Tiếng Việt, truyền cảm hứng và tinh thần đoàn kết của cộng đồng Ohana trên toàn cầu.'
  },
  {
    id: 'k7eo_NnI7uI',
    title: 'HƯỚNG DẪN ĐĂNG KÝ TÀI KHOẢN ASTRONIXA',
    duration: '1:16',
    category: 'Quy trình SOP Astronixa',
    group: 'ohana',
    channel: 'Ohana Astronixa VN',
    badge: 'SOP 01',
    ...
    courseId: 6,
    lessonId: 23,
    description: 'Quy trình chuẩn từng bước thao tác tạo tài khoản thành viên Astronixa nhanh chóng và an toàn tuyệt đối.'
  },
  {
    id: '3Gr7Zo8cK8Q',
    title: 'HƯỚNG DẪN KYC TÀI KHOẢN ASTRONIXA',
    duration: '2:03',
    category: 'Xác minh & Bảo mật',
    group: 'ohana',
    channel: 'Ohana Astronixa VN',
    badge: 'SOP 02',
    ...
    courseId: 6,
    lessonId: 24,
    description: 'Hướng dẫn quy trình định danh điện tử KYC bảo mật 2 lớp, bảo đảm an toàn quyền lợi và tài sản của thành viên.'
  },
  {
    id: '8Oljb4DCwlo',
    ...
    courseId: 6,
    lessonId: 25,
    description: 'Hướng dẫn nạp điểm/tiền vào ví Astronixa đúng địa chỉ, khớp lệnh tự động nhanh chóng và minh bạch.'
  },
  {
    id: 'sPvb7_qvIWs',
    ...
    courseId: 6,
    lessonId: 26,
    description: 'Quy trình lựa chọn gói sản phẩm, thanh toán và kích hoạt quyền lợi thành viên cao cấp trong hệ sinh thái.'
  },
  {
    id: 'l9vAc7C8Zz4',
    ...
    courseId: 6,
    lessonId: 27,
    description: 'Hướng dẫn thao tác tạo lệnh rút tiền về ví cá nhân bảo mật, xác thực giao dịch nhanh gọn và thuận tiện.'
  },

  // ── 2. Sáng Tạo Ảnh & Video AI ──
  {
    id: 'B1hOFU-Wzf8',
    title: 'Làm Chủ Midjourney V6: Hướng Dẫn Chi Tiết Toàn Tập Cho Người Mới',
    duration: '12:45',
    category: 'Tạo Ảnh AI Thực Chiến',
    group: 'ai_media',
    channel: 'AI Design Master',
    badge: 'AI Art Demo',
    embedUrl: 'https://www.youtube.com/embed/B1hOFU-Wzf8',
    watchUrl: 'https://www.youtube.com/watch?v=B1hOFU-Wzf8',
    thumbnail: 'https://i.ytimg.com/vi/B1hOFU-Wzf8/hqdefault.jpg',
    courseId: 1,
    lessonId: 1,
    description: 'Tìm hiểu cấu trúc prompt chuẩn chỉnh, điều khiển tỷ lệ khung hình, ánh sáng và phong cách nghệ thuật siêu thực với Midjourney V6.'
  },
  {
    id: '8p_hS2Z1M2M',
    title: 'Bí Quyết Giữ Khuôn Mặt & Phong Cách Nhân Vật Đồng Nhất (--cref, --sref)',
    duration: '15:20',
    category: 'Tạo Ảnh AI Thực Chiến',
    group: 'ai_media',
    channel: 'AI Design Master',
    badge: 'Midjourney V6',
    embedUrl: 'https://www.youtube.com/embed/8p_hS2Z1M2M',
    watchUrl: 'https://www.youtube.com/watch?v=8p_hS2Z1M2M',
    thumbnail: 'https://i.ytimg.com/vi/8p_hS2Z1M2M/hqdefault.jpg',
    courseId: 1,
    lessonId: 2,
    description: 'Kỹ thuật giữ nhất quán khuôn mặt nhân vật qua nhiều bối cảnh khác nhau, tạo bộ ảnh thương mại và ấn phẩm marketing nhất quán.'
  },
  {
    id: 'd7oxhBrx4v8',
    title: 'Làm Chủ Runway Gen-3 Alpha: Điều Khiển Camera Chuyển Động Điện Ảnh',
    duration: '14:18',
    category: 'Sản Xuất Video AI',
    group: 'ai_media',
    channel: 'Filmmaking AI Lab',
    badge: 'Runway Gen-3',
    embedUrl: 'https://www.youtube.com/embed/d7oxhBrx4v8',
    watchUrl: 'https://www.youtube.com/watch?v=d7oxhBrx4v8',
    thumbnail: 'https://i.ytimg.com/vi/d7oxhBrx4v8/hqdefault.jpg',
    courseId: 2,
    lessonId: 6,
    description: 'Khám phá sức mạnh của Runway Gen-3 Alpha: Prompt chuyển động camera pan, tilt, zoom điện ảnh và motion control mượt mà.'
  },
  {
    id: 'A-a1VrtPeTY',
    title: 'Sản Xuất Video AI Toàn Diện: Từ Ý Tưởng Kịch Bản Đến Video Viral Triệu View',
    duration: '18:30',
    category: 'Sản Xuất Video AI',
    group: 'ai_media',
    channel: 'Filmmaking AI Lab',
    badge: 'AI Video Master',
    embedUrl: 'https://www.youtube.com/embed/A-a1VrtPeTY',
    watchUrl: 'https://www.youtube.com/watch?v=A-a1VrtPeTY',
    thumbnail: 'https://i.ytimg.com/vi/A-a1VrtPeTY/hqdefault.jpg',
    courseId: 2,
    lessonId: 5,
    description: 'Quy trình kết hợp ChatGPT tạo storyboard, Midjourney tạo khung hình và Runway tạo chuyển động video ngắn viral.'
  },

  // ── 3. AI Agent & Tự Động Hóa ──
  {
    id: 'dpoMEcXjVH8',
    title: 'Xây Dựng AI Agent Đầu Tiên Miễn Phí Với n8n Tự Động Hóa Doanh Nghiệp',
    duration: '21:15',
    category: 'AI Agent & Automation',
    group: 'ai_agent',
    channel: 'Automation Hub',
    badge: 'n8n AI Agent',
    embedUrl: 'https://www.youtube.com/embed/dpoMEcXjVH8',
    watchUrl: 'https://www.youtube.com/watch?v=dpoMEcXjVH8',
    thumbnail: 'https://i.ytimg.com/vi/dpoMEcXjVH8/hqdefault.jpg',
    courseId: 3,
    lessonId: 9,
    description: 'Hướng dẫn tự thiết kế một AI Agent thông minh xử lý email, phân loại công việc và tự động gửi thông báo với n8n.'
  },
  {
    id: 'lSwMtsm6oDU',
    title: 'Hướng Dẫn Xây Dựng Multi-Agent Chuyên Sâu: Memory & RAG Tool (Từ Cơ Bản Đến Pro)',
    duration: '25:40',
    category: 'AI Agent & Automation',
    group: 'ai_agent',
    channel: 'Automation Hub',
    badge: 'Multi-Agent Pro',
    embedUrl: 'https://www.youtube.com/embed/lSwMtsm6oDU',
    watchUrl: 'https://www.youtube.com/watch?v=lSwMtsm6oDU',
    thumbnail: 'https://i.ytimg.com/vi/lSwMtsm6oDU/hqdefault.jpg',
    courseId: 3,
    lessonId: 10,
    description: 'Kiến trúc hệ thống Agentic AI kết hợp bộ nhớ đệm, truy xuất dữ liệu doanh nghiệp và liên kết các luồng tự động hóa.'
  },
  {
    id: '9lqloLQ1roc',
    title: 'Xây Dựng AI Agent Tự Học Hỏi (Self-Learning Agent) Đột Phá Năng Suất',
    duration: '19:50',
    category: 'AI Agent & Automation',
    group: 'ai_agent',
    channel: 'Automation Hub',
    badge: 'Advanced AI',
    embedUrl: 'https://www.youtube.com/embed/9lqloLQ1roc',
    watchUrl: 'https://www.youtube.com/watch?v=9lqloLQ1roc',
    thumbnail: 'https://i.ytimg.com/vi/9lqloLQ1roc/hqdefault.jpg',
    courseId: 3,
    lessonId: 12,
    description: 'Xây dựng trợ lý ảo có khả năng tự tích lũy kiến thức từ hội thoại người dùng và tối ưu hóa phản hồi kinh doanh liên tục.'
  },

  // ── 4. Kỹ Năng Bán Hàng & Đàm Phán ──
  {
    id: 'pzPDE7S6sEc',
    title: 'BÁN HÀNG THÀNH CÔNG: Phương Pháp FAB & Thấu Hiểu Tâm Lý Khách Hàng',
    duration: '16:40',
    category: 'Kỹ Năng Bán Hàng',
    group: 'sales',
    channel: 'Master Sales Academy',
    badge: 'Bán Hàng FAB',
    embedUrl: 'https://www.youtube.com/embed/pzPDE7S6sEc',
    watchUrl: 'https://www.youtube.com/watch?v=pzPDE7S6sEc',
    thumbnail: 'https://i.ytimg.com/vi/pzPDE7S6sEc/hqdefault.jpg',
    courseId: 4,
    lessonId: 13,
    description: 'Nghệ thuật trình bày sản phẩm thuyết phục qua mô hình Feature - Advantage - Benefit, đánh trúng tâm lý và nỗi đau khách hàng.'
  },
  {
    id: 'dxKTMvU_RXw',
    title: 'Nghệ Thuật Bán Hàng Đỉnh Cao: 8 Bước Tiếp Cận & Khám Phá Nhu Cầu SPIN',
    duration: '22:15',
    category: 'Kỹ Năng Bán Hàng',
    group: 'sales',
    channel: 'Master Sales Academy',
    badge: 'SPIN Selling',
    embedUrl: 'https://www.youtube.com/embed/dxKTMvU_RXw',
    watchUrl: 'https://www.youtube.com/watch?v=dxKTMvU_RXw',
    thumbnail: 'https://i.ytimg.com/vi/dxKTMvU_RXw/hqdefault.jpg',
    courseId: 4,
    lessonId: 14,
    description: 'Bộ câu hỏi SPIN kinh điển khai mở nhu cầu tiềm ẩn của khách hàng, tạo niềm tin vững chắc trước khi giới thiệu giải pháp.'
  },
  {
    id: 'gPcefP5Vrxk',
    title: 'Tuyệt Chiêu Hóa Giải Phản Đối & Kỹ Thuật Chốt Sale Bậc Cao',
    duration: '28:10',
    category: 'Kỹ Năng Bán Hàng',
    group: 'sales',
    channel: 'Master Sales Academy',
    badge: 'Chốt Sale Đỉnh',
    embedUrl: 'https://www.youtube.com/embed/gPcefP5Vrxk',
    watchUrl: 'https://www.youtube.com/watch?v=gPcefP5Vrxk',
    thumbnail: 'https://i.ytimg.com/vi/gPcefP5Vrxk/hqdefault.jpg',
    courseId: 4,
    lessonId: 15,
    description: 'Chiến thuật 3F (Feel - Felt - Found) và bẻ gãy rào cản giá cao, chốt hợp đồng tự nhiên mà không tạo cảm giác ép buộc.'
  },
  {
    id: 'jfVi3jD6ym4',
    title: 'Nghệ Thuật Bán Hàng Bằng Câu Chuyện (Storytelling In Sales)',
    duration: '20:35',
    category: 'Kỹ Năng Bán Hàng',
    group: 'sales',
    channel: 'Master Sales Academy',
    badge: 'Storytelling',
    embedUrl: 'https://www.youtube.com/embed/jfVi3jD6ym4',
    watchUrl: 'https://www.youtube.com/watch?v=jfVi3jD6ym4',
    thumbnail: 'https://i.ytimg.com/vi/jfVi3jD6ym4/hqdefault.jpg',
    courseId: 4,
    lessonId: 16,
    description: 'Cách sử dụng câu chuyện thành công của khách hàng cũ để kích thích cảm xúc, tạo động lực mua hàng ngay trong buổi tư vấn.'
  },

  // ── 5. Thuyết Trình, Lãnh Đạo & Huấn Luyện ──
  {
    id: 'whpBTWvCU6o',
    title: 'Làm Sao Để KHÔNG RUN Khi Giao Tiếp & Thuyết Trình Trước Đám Đông?',
    duration: '18:25',
    category: 'Giao Tiếp & Thuyết Trình',
    group: 'leadership',
    channel: 'Public Speaking Pro',
    badge: 'Thuyết Trình Tự Tin',
    embedUrl: 'https://www.youtube.com/embed/whpBTWvCU6o',
    watchUrl: 'https://www.youtube.com/watch?v=whpBTWvCU6o',
    thumbnail: 'https://i.ytimg.com/vi/whpBTWvCU6o/hqdefault.jpg',
    courseId: 5,
    lessonId: 19,
    description: 'Bí quyết thở sâu, kiểm soát nhịp tim và vượt qua nỗi sợ hãi khi đứng trước đám đông để tự tin làm chủ sân khấu.'
  },
  {
    id: 'M44jmuvYlbs',
    title: 'Bí Quyết "Ăn Nói" Khéo Léo Của Người Giao Tiếp Thông Minh',
    duration: '15:45',
    category: 'Giao Tiếp & Thuyết Trình',
    group: 'leadership',
    channel: 'Public Speaking Pro',
    badge: 'Giao Tiếp EQ',
    embedUrl: 'https://www.youtube.com/embed/M44jmuvYlbs',
    watchUrl: 'https://www.youtube.com/watch?v=M44jmuvYlbs',
    thumbnail: 'https://i.ytimg.com/vi/M44jmuvYlbs/hqdefault.jpg',
    courseId: 5,
    lessonId: 18,
    description: 'Cách lựa chọn từ ngữ tinh tế, điều chỉnh ánh mắt và nụ cười để tạo thiện cảm và thuyết phục đối phương ngay từ lời chào đầu tiên.'
  },
  {
    id: 'L3R-RzQ_ZKA',
    title: 'Kỹ Năng Lãnh Đạo Đột Phá & Quản Trị Đội Ngũ Thực Chiến',
    duration: '24:10',
    category: 'Lãnh Đạo & Quản Trị',
    group: 'leadership',
    channel: 'Leadership & Coaching',
    badge: 'Lãnh Đạo Đột Phá',
    embedUrl: 'https://www.youtube.com/embed/L3R-RzQ_ZKA',
    watchUrl: 'https://www.youtube.com/watch?v=L3R-RzQ_ZKA',
    thumbnail: 'https://i.ytimg.com/vi/L3R-RzQ_ZKA/hqdefault.jpg',
    courseId: 7,
    lessonId: 28,
    description: 'Chuyển dịch tư duy quản lý sang lãnh đạo truyền cảm hứng, thấu hiểu năng lực cá nhân và xây dựng lòng tin bền vững trong đội ngũ.'
  },
  {
    id: '0_YJWgSKPzw',
    title: 'Train the Trainer: Phương Pháp Sư Phạm & Huấn Luyện Đội Ngũ Đỉnh Cao',
    duration: '26:50',
    category: 'Train the Trainer',
    group: 'leadership',
    channel: 'Master Trainer Academy',
    badge: 'Train the Trainer',
    embedUrl: 'https://www.youtube.com/embed/0_YJWgSKPzw',
    watchUrl: 'https://www.youtube.com/watch?v=0_YJWgSKPzw',
    thumbnail: 'https://i.ytimg.com/vi/0_YJWgSKPzw/hqdefault.jpg',
    courseId: 8,
    lessonId: 32,
    description: 'Phương pháp sư phạm tương tác, kỹ thuật thiết kế bài giảng tinh gọn và nghệ thuật điều phối lớp học sôi nổi, hiệu quả.'
  }
];
...
function initDB() {
      ...
      const updated = existing.map(ec => {
        ...
        if (def) {
          return {
            ...def,
            ...ec,
            thumbnail: def.thumbnail || ec.thumbnail || '',
            allowedRoles: ['admin', 'employee_new', 'employee_old', 'customer'],
  ...
  if (!localStorage.getItem(DB_KEYS.lessons) || storedVer !== DB_VERSION) {
    ...
    const mergedLessons = DEFAULT_LESSONS.map(dl => {
      const el = existingLessons.find(e => e.id === dl.id);
      return el ? { ...el, videoUrl: dl.videoUrl, title: dl.title, duration: dl.duration, description: dl.description } : dl;
    });
